...
$sql="SELECT customer_id, customer_name, customer_phone_no, Billing_address, Email_address FROM customer";
...
if(mysqli_num_rows($result)>0)
{
	...
	{
?>
<form  method="post" action="http://localhost/Hera_Florist/Admin/Customer_list.php">
...
<td><input type="submit" name="Delete" class='dropbtn' value="DELETE"></td>
</tr>
</form>
<?php
}
